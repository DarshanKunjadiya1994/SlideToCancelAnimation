...
- (void)setBucketStyle:(BucketStyle)bucketStyle
{
    ...
    switch (_bucketStyle) {
        case BucketStyle1OpenFromRight:
            self.bucketLidImage = [UIImage imageNamed:@"BucketLid.png"];
            self.bucketBodyImage = [UIImage imageNamed:@"BucketBody.png"];
        ...
        case BucketStyle2OpenFromRight:
            self.bucketLidImage = [UIImage imageNamed:@"bucket_lid_style2.png"];
            self.bucketBodyImage = [UIImage imageNamed:@"bucket_body_style2.png"];
            self.animationDuration = 0.1;
            self.animationTimingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
